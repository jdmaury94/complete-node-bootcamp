...
app.use('/api/v1/reviews', reviewRouter); //Apply userRouter middleware to /api/v1/reviews route
app.use('/api/v1/bookings', bookingRouter); //Apply userRouter middleware to /api/v1/bookings route
